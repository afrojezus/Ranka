...
{
    // Based on https://github.com/domnguyen/Discord-Bot/blob/master/src/Helpers/AudioPlayer.cs
    internal class MidoPlayer
    {
        // Private variables.
        ...
        private async Task AudioPlaybackAsync(IAudioClient client, MidoFile song)
        {
            // Set running to true.
            m_IsRunning = true;
        ...
        public async Task Play(IAudioClient client, MidoFile song)
        {
